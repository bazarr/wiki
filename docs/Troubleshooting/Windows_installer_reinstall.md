...
1. Follow instructions here to install Bazarr using the latest Windows Installer (but don't delete the `%PROGRAMDATA%\Bazarr` directory): [[Instructions]](/Getting-Started/Installation/Windows/installer/)
